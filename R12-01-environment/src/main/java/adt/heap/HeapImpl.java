...
/**
 * Implementação de uma heap binária. A implementação padrão é de uma min-heap, ou seja, 
 * o elemento menor fica no topo da heap. 
 * 
...
public class HeapImpl<T extends Comparable<T>> implements Heap<T> {
	...
	@SuppressWarnings("unchecked")
	public T[] toArray() {
		return Arrays.copyOf(this.heap, this.index + 1);
	}
